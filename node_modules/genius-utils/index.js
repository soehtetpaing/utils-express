...
// console.log("syskey: ", CommonHandler.getSyskey(workerId, datacenterID));
// console.log("syskey: ", CommonHandler.getSyskey(2, 2));
...
// const json = MediaHandler.getMediaWithDirectory('media', 'test.txt');
...
// console.log("Read Text:", await MediaHandler.readJSON(json));
...
// AuthHandler
// console.log("JWT_SECRET: ", AuthHandler.generateJwtSecret());
// console.log("REFRESH_SECRET: ", AuthHandler.generateJwtSecret());
// console.log("API_SECRET: ", AuthHandler.generateJwtSecret());
...
//   role: 'user'
// }
// const res = AuthHandler.generateJwtToken(user);
// console.log(res);
// const decoded = AuthHandler.verifyJwtToken(res.tokens.accessToken, JWT_SECRET);
// console.log(decoded);
// const refreshDecoded = AuthHandler.verifyJwtToken(res.tokens.refreshToken, REFRESH_SECRET)
// console.log(refreshDecoded);

// console.log("UUID: ", AuthHandler.getUniqueId());
// console.log("Encrypt:", AuthHandler.encrypt("123"));
// console.log("Decrypt:", AuthHandler.decrypt("ZdSemJPKQmS6uRrEpoUATqwoyVK77zOwPgMbxqTzPHQ="));
// console.log("Decrypt (With Secret):", AuthHandler.decrypt("ZdSemJPKQmS6uRrEpoUATqwoyVK77zOwPgMbxqTzPHQ=", "OhMyGenius!"));

// console.log("Encrypt:", AuthHandler.encrypt("@dminP@ssw0rd", "ms365"));
// console.log("Decrypt:", AuthHandler.decrypt("3IQyFcVt8K1Y1OE0dmaaEbbLIBVgGFam36Ok/MEVEEI=", "ms365"));
// console.log("Decrypt (Wrong Secret):", AuthHandler.decrypt("3IQyFcVt8K1Y1OE0dmaaEbbLIBVgGFam36Ok/MEVEEI="));
